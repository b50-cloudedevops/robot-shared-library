def sonarCheck() {
    sh '''
          ...
          sonar-quality-gate ${SONAR_USR} ${SONAR_PSW} 172.31.1.192 ${COMPONENT} // This gives the result of the scan based on that it will abort pipeline or proceed further    
